 ...
 * <ul>
 *   <li>{@link classDiagram.impl.ElementTypeImpl#isIsCollection <em>Is Collection</em>}</li>
 *   <li>{@link classDiagram.impl.ElementTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementTypeImpl extends MinimalEObjectImpl.Container implements ElementType {
	...
	protected EClass eStaticClass() {
		return ClassDiagramPackage.Literals.ELEMENT_TYPE;
	}
	...
	public void setIsCollection(boolean newIsCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassDiagramPackage.ELEMENT_TYPE__IS_COLLECTION, oldIsCollection, isCollection));
	}
	...
	public Classifier getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassDiagramPackage.ELEMENT_TYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Classifier newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassDiagramPackage.ELEMENT_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassDiagramPackage.ELEMENT_TYPE__IS_COLLECTION:
				return isIsCollection();
			case ClassDiagramPackage.ELEMENT_TYPE__TYPE:
