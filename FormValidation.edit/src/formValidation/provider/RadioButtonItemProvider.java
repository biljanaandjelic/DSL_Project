...
/**
 * This is the item provider adapter for a {@link formValidation.RadioButton} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RadioButtonItemProvider extends SelectingUIComponentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RadioButton_orientation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RadioButton_orientation_feature", "_UI_RadioButton_type"),
				 FormValidationPackage.Literals.RADIO_BUTTON__ORIENTATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((RadioButton)object).getTooltip();
