...
/**
 * This is the item provider adapter for a {@link formValidation.LessThan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LessThanItemProvider extends ClassRuleItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LessThan_classattribute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LessThan_classattribute_feature", "_UI_LessThan_type"),
				 FormValidationPackage.Literals.LESS_THAN__CLASSATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormValidationPackage.Literals.LESS_THAN__ATTRIBUTEARRAY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormValidationPackage.Literals.LESS_THAN__ATTRIBUTEARRAY,
