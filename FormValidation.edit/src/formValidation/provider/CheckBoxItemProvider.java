...
/**
 * This is the item provider adapter for a {@link formValidation.CheckBox} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheckBoxItemProvider extends SelectingUIComponentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CheckBox_orientation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CheckBox_orientation_feature", "_UI_CheckBox_type"),
				 FormValidationPackage.Literals.CHECK_BOX__ORIENTATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((CheckBox)object).getTooltip();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CheckBox.class)) {
			case FormValidationPackage.CHECK_BOX__ORIENTATION:
