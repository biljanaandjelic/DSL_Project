...
/**
 * This is the item provider adapter for a {@link formValidation.PrimitiveDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveDataTypeItemProvider extends AttributeDataTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormValidationPackage.Literals.PRIMITIVE_DATA_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		PrimitiveDataType primitiveDataType = (PrimitiveDataType)object;
		return getString("_UI_PrimitiveDataType_type") + " " + primitiveDataType.isIsCollection();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveDataType.class)) {
			case FormValidationPackage.PRIMITIVE_DATA_TYPE__TYPE:
