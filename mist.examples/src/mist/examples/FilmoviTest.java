...
public class FilmoviTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_filmovi/filmovi.erdsl";
	private static final String EXAMPLES_DIR 	= "filmovi/";
	private static final String ER_M 			= EXAMPLES_DIR + "filmoviER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "filmoviRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "filmoviClass.xmi";
