...
public class ApotekaTest {
	//this part should be changed on each computer
	//VD home PC
	private static final String PATH_TO_REPO 	= "file:/E:/domij/domij/";
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_apoteka/apoteka.erdsl";
	private static final String EXAMPLES_DIR 	= "apoteka/";
	private static final String ER_M 			= EXAMPLES_DIR + "apotekaER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "apotekaRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "apotekaClass.xmi";
