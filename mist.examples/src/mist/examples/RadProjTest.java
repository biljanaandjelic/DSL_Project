...
public class RadProjTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_radproj/radproj.erdsl";
	private static final String EXAMPLES_DIR 	= "radproj/";
	private static final String ER_M 			= EXAMPLES_DIR + "radprojER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "radprojRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "radprojClass.xmi";
