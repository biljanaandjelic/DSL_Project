...
public class PowerPlantTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_powerPlant/powerPlant.erdsl";
	private static final String EXAMPLES_DIR 	= "powerPlant/";
	private static final String ER_M 			= EXAMPLES_DIR + "powerPlantER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "powerPlantRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "powerPlantClass.xmi";
