...
public class BankaTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_banka/banka.erdsl";
	private static final String EXAMPLES_DIR 	= "banka/";
	private static final String ER_M 			= EXAMPLES_DIR + "bankaER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "bankaRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "bankaClass.xmi";
