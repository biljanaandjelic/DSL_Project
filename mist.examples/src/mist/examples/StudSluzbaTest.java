...
public class StudSluzbaTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_studsluzba/studsluzba.erdsl";
	private static final String EXAMPLES_DIR 	= "studsluzba/";
	private static final String ER_M 			= EXAMPLES_DIR + "studsluzbaER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "studsluzbaRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "studsluzbaClass.xmi";
