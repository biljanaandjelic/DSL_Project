...
public class CASEAlatTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_casealat/casealat.erdsl";
	private static final String EXAMPLES_DIR 	= "casealat/";
	private static final String ER_M 			= EXAMPLES_DIR + "casealatER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "casealatRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "casealatClass.xmi";
