...
public class DeloviTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_delovi/delovi.erdsl";
	private static final String EXAMPLES_DIR 	= "delovi/";
	private static final String ER_M 			= EXAMPLES_DIR + "deloviER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "deloviRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "deloviClass.xmi";
