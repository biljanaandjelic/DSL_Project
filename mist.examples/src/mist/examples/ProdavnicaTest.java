...
public class ProdavnicaTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_prodavnica/prodavnica.erdsl";
	private static final String EXAMPLES_DIR 	= "prodavnica/";
	private static final String ER_M 			= EXAMPLES_DIR + "prodavnicaER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "prodavnicaRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "prodavnicaClass.xmi";
