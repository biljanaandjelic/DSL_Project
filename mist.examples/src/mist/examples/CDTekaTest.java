...
public class CDTekaTest {
	...
	private static final String ER_ERDSL_M	 	= PATH_TO_REPO + "mist.examples/erdsl/_cdteka/cdteka.erdsl";
	private static final String EXAMPLES_DIR 	= "cdteka/";
	private static final String ER_M 			= EXAMPLES_DIR + "cdtekaER.xmi";
	private static final String RDBMS_M 		= EXAMPLES_DIR + "cdtekaRel.xmi";
	private static final String CLASS_M 		= EXAMPLES_DIR + "cdtekaClass.xmi";
