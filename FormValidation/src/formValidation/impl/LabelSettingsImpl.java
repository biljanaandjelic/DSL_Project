 ...
 * </p>
 * <ul>
 *   <li>{@link formValidation.impl.LabelSettingsImpl#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabelSettingsImpl extends AdditionalSettingsImpl implements LabelSettings {
	/**
	...
	protected EClass eStaticClass() {
		return FormValidationPackage.Literals.LABEL_SETTINGS;
	}
	...
	public void setPosition(EPosition newPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormValidationPackage.LABEL_SETTINGS__POSITION, oldPosition, position));
	}
