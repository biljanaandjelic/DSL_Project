 ...
 * </p>
 * <ul>
 *   <li>{@link formValidation.impl.EqualsImpl#getAttributearray <em>Attributearray</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualsImpl extends ClassRuleImpl implements Equals {
	/**
	...
	protected EClass eStaticClass() {
		return FormValidationPackage.Literals.EQUALS;
	}
	...
	public NotificationChain basicSetAttributearray(AttributeArray newAttributearray, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormValidationPackage.EQUALS__ATTRIBUTEARRAY, oldAttributearray, newAttributearray);
	...
	public void setAttributearray(AttributeArray newAttributearray) {
		if (newAttributearray != attributearray) {
			...
			if (attributearray != null)
				msgs = ((InternalEObject)attributearray).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormValidationPackage.EQUALS__ATTRIBUTEARRAY, null, msgs);
			if (newAttributearray != null)
				msgs = ((InternalEObject)newAttributearray).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormValidationPackage.EQUALS__ATTRIBUTEARRAY, null, msgs);
			msgs = basicSetAttributearray(newAttributearray, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormValidationPackage.EQUALS__ATTRIBUTEARRAY, newAttributearray, newAttributearray));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FormValidationPackage.EQUALS__ATTRIBUTEARRAY:
