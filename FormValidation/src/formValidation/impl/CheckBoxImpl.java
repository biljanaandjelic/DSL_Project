 ...
 * </p>
 * <ul>
 *   <li>{@link formValidation.impl.CheckBoxImpl#getOrientation <em>Orientation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CheckBoxImpl extends SelectingUIComponentImpl implements CheckBox {
	...
	protected EClass eStaticClass() {
		return FormValidationPackage.Literals.CHECK_BOX;
	}
	...
	public void setOrientation(EOrientation newOrientation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormValidationPackage.CHECK_BOX__ORIENTATION, oldOrientation, orientation));
	}
