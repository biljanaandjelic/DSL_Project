 ...
 * </p>
 * <ul>
 *   <li>{@link formValidation.impl.GreaterThanImpl#getClassattribute <em>Classattribute</em>}</li>
...
public class GreaterThanImpl extends ClassRuleImpl implements GreaterThan {
		...
		if (classattribute != null && classattribute.eIsProxy()) {
			...
			if (classattribute != oldClassattribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormValidationPackage.GREATER_THAN__CLASSATTRIBUTE, oldClassattribute, classattribute));
			}
		}
	...
	public void setClassattribute(ClassAttribute newClassattribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormValidationPackage.GREATER_THAN__CLASSATTRIBUTE, oldClassattribute, classattribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormValidationPackage.GREATER_THAN__CLASSATTRIBUTE:
