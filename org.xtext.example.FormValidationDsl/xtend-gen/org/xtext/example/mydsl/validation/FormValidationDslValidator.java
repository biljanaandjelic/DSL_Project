...
import org.xtext.example.mydsl.validation.AbstractFormValidationDslValidator;
...
public class FormValidationDslValidator extends AbstractFormValidationDslValidator {
  ...
  public void checkClassName(final ValidationClass valClass) {
    ...
    if (_not) {
      this.warning("Class name should start with a capital", FormValidationPackage.Literals.VALIDATION_CLASS__NAME, FormValidationDslValidator.INVALID_NAME);
    }
  }
  ...
  public void checkAttributeName(final ClassAttribute classAttribute) {
    ...
    if (_not) {
      this.warning("Attribute name should start with a lowercase letter", 
        FormValidationPackage.Literals.CLASS_ATTRIBUTE__NAME, FormValidationDslValidator.INVALID_NAME);
    }
  }
  ...
  public void checkDateFormat(final ClassAttribute attribute) {
    ...
    if (!_isDateType) {
      ...
      _and = _isDatePatternDefined;
    }
    if (_and) {
      String datePattern = this.getDatePatern(attribute);
      ...
      if (!_isMinDateDefined_1) {
        ...
        _and_1 = _isMaxDateDefined_1;
      }
      if (_and_1) {
        String minDateValue_1 = this.getMinDate(attribute);
        String maxDateValue_1 = this.getMaxDate(attribute);
        boolean _compareMinAndMaxDate = this.compareMinAndMaxDate(minDateValue_1, maxDateValue_1, "dd/MM/yyyy");
