...
import org.xtext.example.mydsl.ide.contentassist.antlr.internal.InternalFormValidationParser;
import org.xtext.example.mydsl.services.FormValidationGrammarAccess;

public class FormValidationParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalFormValidationParser createParser() {
		InternalFormValidationParser result = new InternalFormValidationParser(null);
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalFormValidationParser typedParser = (InternalFormValidationParser) parser;
