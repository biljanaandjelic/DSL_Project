    ...
    def generateHTML(BusinessModel businessModel){
    	...
    	.ui-helper-hidden-accessible {
    	  ...
    	  width: 1px;
    	    ...
    	    <div class="form-group col-md-6  additonalInfo-field">    	        	    <div><span><label> «generateInputLabel(nonMasterAttributes.get(i).name,nonMasterAttributes.get(i).label)» :</label></span><span class="additionalInfo" name="«nonMasterAttributes.get(i).name»"></span> </div>    	 	</div>    	  «IF i == nonMasterAttributes.size-1»    	  	</div>    	  «ENDIF»    	 «ELSE»    	 	<div class="form-group col-md-6 additonalInfo-field">    	 	 <div><span><label> «generateInputLabel(nonMasterAttributes.get(i).name,nonMasterAttributes.get(i).label)» : </label></span><span class="additionalInfo" name="«nonMasterAttributes.get(i).name»"></span> </div>
